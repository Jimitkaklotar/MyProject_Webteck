...
export const Hero = () => {
    ...
    return (
        <>
            <div className='flex justify-center max-sm:gap-10  pt-10 overflow-hidden flex-wrap max-lg:gap-2' id="Hero">
                <div className=' bg-cover bg-center px-20 pt-40 max-sm:pt-20 max-sm:px-5 ' style={{ backgroundImage: `url(${text})` }}  data-aos="fade-right" data-aos-duration="1800">
                    <h3 className='text-3xl text-[#684DF4] font-semibold pb-13 max-sm:text-sm '>Solution For Your Business</h3>
                    ...
                    <p>Rapidiously streamline revolutionary networks with technically sound deliverables. Authoritatively<br/>
                ...
                <div  data-aos="fade-left" data-aos-duration="1800">
                    <img src={hero} alt="" className='mt-20'/>
                </div>
            </div>
