...
const Footer = () => {
    return (
        <footer className="bg-[#e9f0f6] text-gray-800 mt-20">
            <div className="bg-[#7c5dfa] text-white p-6 rounded-t-3xl grid grid-cols-1 md:grid-cols-3 py-10 max-md:gap-10 ">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 bg-[#B5C6EB]  gap-10 p-8 items-center ">
