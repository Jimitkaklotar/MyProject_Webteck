    ...
    return (
        <>
            ...
            <div className='flex justify-between items-center bg-[#E1EAF4] p-5 rounded-2xl max-sm:rounded-none w-full fixed z-50 top-0'>
                ...
                <img src={logo} alt="logo" className='h-14 max-sm:h-10' />
                    ...
                    <div className='hidden lg:block'>
                        {showSearch ? (
                            <input
                                ...
                                autoFocus
                                placeholder="Search..."
                                className="px-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 cursor-pointer focus:ring-[#6C4DFF] w-64"
                            />
                        ) : (
                            <button className="bg-[#684DF4] text-white font-semibold px-6 py-2 w-64 rounded-2xl cursor-pointer">
                                Contact us
                            </button>
                        )}
                    </div>
