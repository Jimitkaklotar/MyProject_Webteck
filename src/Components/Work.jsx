...
const Work = () => {
    ...
    return (
        <>
            <div className='bg-gradient-to-r from-[#B5C6EB]  to-[#ECE5B5] py-20 px-20 rounded-4xl my-30 max-sm:px-5  ' id="work">
                ...
                <div className="grid md:grid-cols-1 lg:grid-cols-3 max-md:grid-cols-1 gap-20 mt-20  ">
                    {services.map((service, index) => (
                        <div key={index} className=" max-sm:gap-5 rounded-4xl flex flex-col  items-center gap-5 shadow-md hover:shadow-xl  transition-all duration-300 bg-white md:w-100 " data-aos="zoom-out" data-aos-duration="1800">
