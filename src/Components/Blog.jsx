    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-3 gap-10  p-10 px-20 max-md:px-5">
        {services.map((service, index) => (
          <div key={index} className=" max-sm:gap-5 rounded-4xl flex flex-col  gap-5 shadow-md hover:shadow-xl transition-all duration-300 bg-white" data-aos="zoom-in" data-aos-duration="1800">
