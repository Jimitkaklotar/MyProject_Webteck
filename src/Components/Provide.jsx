...
const Provide = () => {
    ...
    return (
        <>
            <div className='bg-gradient-to-r from-[#B5C6EB]  to-[#ECE5B5] py-20 px-10 rounded-4xl my-30 max-sm:px-5' id="service">
                <div className='flex px-15  justify-center flex-wrap gap-20 items-center max-sm:px-5'>
